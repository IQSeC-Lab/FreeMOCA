...
from function_joint import get_iter_test_dataset, test, oh, get_iter_train_dataset, get_dataloader
...
for task in range(nb_task):
    ...
    if task == nb_task-1:
        ...
        print("The Global Average:", sum(ls_accuracy)/len(ls_accuracy))More actions
