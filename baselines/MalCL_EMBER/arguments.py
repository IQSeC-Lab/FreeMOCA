...
def _parse_args():
    ...
    parser.add_argument(
        '--batchsize', type=int, default=512
    )
    ...
    parser.add_argument('--train_data', default = '../data/EMBER_Class', help='Path of train data')

    parser.add_argument('--test_data', default = '../data/EMBER_Class', help='Path of test data')
