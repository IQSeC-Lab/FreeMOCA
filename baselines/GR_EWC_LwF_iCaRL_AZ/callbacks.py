...
def _metric_cb(args, log, test_datasets, metrics_dict=None, iters_per_task=None, test_size=None, classes_per_task=None,
    ...
    def metric_cb(args, classifier, batch, task=1):
        ...
        # evaluate the solver on multiple tasks (and log to visdom)
        if iteration % log == 0:
            evaluate.metric_statistics(args, classifier, test_datasets, task, iteration,
