...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    print("############## DEBUG added new sub_dataset")
    # EMBER랑 AZ 데이터 로드 다르게 하기 위해서 추가
    parser.add_argument('--sub_dataset', type=str, required=True, choices=["ember", "az"])
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--n_tasks', type=int, default=11)
