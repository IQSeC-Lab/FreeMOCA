...
from convs.cifar_resnet import resnet32_ember, resnet32_az
...
def get_convnet(args, pretrained=False):
    ...
    #------
    if name == "resnet32_ember":
        return resnet32_ember()
    elif name == "resnet32_az":
        return resnet32_az()
    #------
    elif name == "resnet18":
        ...
        return resnet152(pretrained=pretrained,args=args)
