...
def _parse_args():
    ...
    parser.add_argument('--train_data', default = '../data/AZ_Class', help='Path of train data')

    parser.add_argument('--test_data', default = '../data/AZ_Class', help='Path of test data')
