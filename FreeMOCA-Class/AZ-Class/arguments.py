...
def _parse_args():
    parser = argparse.ArgumentParser(description='Class-IL')
    ...
    parser.add_argument('--train_data', default = "/path/to/data", help='Path of train data')
    parser.add_argument('--test_data', default = '/path/to/data', help='Path of test data')
