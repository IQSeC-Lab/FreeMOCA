...
def get_ember_test_data(data_dir):
    ...
    # A  is a PyTorch tensor designed to hold integer data. It's often used for labels in machine learning, especially when performing classification tasks where each label corresponds to a class index.
